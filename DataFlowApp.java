...
class DataTransformer {
	...
	static int byteToInteger( byte value ) {
		if( value >= -2147483648 && value <= 2147483647) {
			...
			System.out.print( "WARNING! the value" + value +  "overflows int range. DATA will was lost!" );
			return 0;
		}
	}
	...
	static double integerToDouble( int value ) {
		if( value >= 2.2250738585072014e-308 && value <= 1.7976931348623158e+308) {
			...
			System.out.print( "WARNING! the value" + value +  "overflows double range. DATA will was lost!" );
			return 0;
		}
	}
	...
	static short integerToShort( int value ) {
		if( value >= -32768 && value <= 32767) {
			...
			System.out.print( "WARNING! the value" + value +  "overflows short range. DATA will was lost!" );
			return 0;
		}
	}
}
